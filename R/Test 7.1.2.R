...
cor.test(students$height,students$weight,alternative="two.sided",method="spearman",exact=NULL,continuity=FALSE)
...
x<-rank(students$height)
y<-rank(students$weight)
